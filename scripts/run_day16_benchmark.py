...
def main():
    ...
    parser.add_argument('--output-dir', type=Path, default=PROJECT_ROOT / 'output/day16_optimization')
...
def finish(root, job_dir, source, plan_bytes, protected, hashes, artifact, raw, scenes, stages, wall):
    ...
    comparison = {}
    for key, baseline in DAY15_BASELINE.items():
        value = measured[key]
        entry = {'day15': baseline, 'day16': value}
    ...
    report = {
        ...
        'day16_comparison_vs_day15': comparison,
        'notes': [
            ...
            'Only the Day-16 opaque line-span fast path changed; Day-11 and Day-13 paths retained.',
            'No progress artifact synthesized. Verifier unchanged.',
        ],
    }
    save(root / 'day16_render_profile.json', report)
    print(json.dumps({k: report[k] for k in ('render_status', 'render_seconds', 'frame_generation_seconds',
                                             ...
                                             'day16_comparison_vs_day15')}, indent=2), flush=True)
